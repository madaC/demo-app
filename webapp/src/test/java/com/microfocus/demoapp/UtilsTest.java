...
public class UtilsTest {
	...
	public void nodifyTestE() {
		String[] result = Utils.notify("/api/some");
		assertEquals(result.length, 1);
		assertEquals(result[0], "some");
	}
	...
	public void nodifyTestF() {
		String[] result = Utils.notify("/api/some/more");
