package com.microfocus.demoapp.tests.ui.testGenerator;
...
public class TestCreator {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, InterruptedException {
        ...
        StringBuffer commandLine = new StringBuffer("-Dtest=TestA_Selenium_JUnit#testUIcaseA+testUIcaseB,TestB_Selenium_JUnit#testUIcaseC+testUIcaseD,");
